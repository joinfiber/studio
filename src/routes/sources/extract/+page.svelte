...
{:else}
	...
	>
		<textarea name="text" rows="10" placeholder="Paste a newsletter or listings text here…"
		></textarea>
		<div class="row">
		...
		<ul class="preview">
			{#each candidates as candidate (candidate.id)}
				<li class="preview-item">
					<button class="remove" title="Drop" onclick={() => removeCandidate(candidate.id)}
						>×</button
					>
