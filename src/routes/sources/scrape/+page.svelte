...
<header class="head">
	<h2>Scrape a page</h2>
	<p class="sub">
		Fetch a listings page, strip it to text, and let the LLM pull out events. The generic path — for
		sites it can't handle, write a site-specific adapter (see <code>docs/extending.md</code>).
...
{:else}
	...
	>
		...
		/>
		<button type="submit" class="primary" disabled={scraping}
